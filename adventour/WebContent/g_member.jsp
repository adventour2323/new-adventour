...
/*입력 값이 있는지 없는지 확인*/
if(g_id == null || g_pw == null || g_name == null || g_nickname == null || g_country == null || g_city == null || g_theme == null || g_img == null || g_email == null || g_emaild == null || g_pnum1 == null || g_pnum1_1 == null || g_pnum1_2 == null || g_birth_y == null || g_birth_m == null || g_birth_d == null || g_gender == null || g_agree1 == null || g_agree2 == null )
...
try{
   ...
   String command = String.format("insert into guide(g_id, g_pw, g_name, g_nickname,  g_country, g_city, g_theme, g_img, g_email, g_pnum, g_birth_y, g_birth_m, g_birth_d, g_gender, g_agree1, g_agree2) values('"+g_id+"', '"+g_pw+"', '"+g_name+"', '"+g_nickname+"', '"+g_country+"', '"+g_city+"', '"+g_theme+"', '"+g_img+"','"+g_email+g_emaild+"', '"+g_pnum1+g_pnum1_1+g_pnum1_2+ "', '"+g_birth_y+"', '"+g_birth_m+"','"+g_birth_d+"','"+g_gender+"', '"+g_agree1+"','"+g_agree2+"');" );
