...
function index() {
    ...
    const howToGo = document.querySelector('.res-tab-bus input');
    const howToGoAir = document.querySelector('.res-tab-bus .how-to-go');
    const howToGoAirUlLi = document.querySelectorAll('.res-tab-bus .how-to-go li');
    ...
    const startTravelDepart_air = document.querySelector('.res-tab-bus .start-travel-depart');
    const startTravelDepartSpan_air = document.querySelector('.res-tab-bus .start-travel-depart span');
    const startSelectDepartUl_air = document.querySelector('.res-tab-bus .select-depart');
    const startSelectDepartList_air = document.querySelectorAll('.res-tab-bus .select-depart li');
    ...
    const startTravelDateAir = document.querySelector('.res-tab-bus .start-travel-date');
    ...
    const startTravelDateSpanAir = document.querySelector('.res-tab-bus .start-travel-date span');
    ...
    const startTravelCalendarAir = document.querySelector('.res-tab-bus .startTravelCalendarAir');
    ...
    const btnHaveAir_air = document.querySelector('.res-tab-bus .btnHaveAir');
    ...
    const btnOnlyTeam_air = document.querySelector('.res-tab-bus .btnOnlyTeam');
